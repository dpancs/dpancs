const migratedPosts = [
  ...
  },
  {
    ...
    "excerpt": "I was recently introduced to this Chrome browser extension called Lastpass. This is a really handy extension that allows you to store passwords for multiple sites. The advantage is that…",
    "body": [
      "I was recently introduced to this Chrome browser extension called Lastpass. This is a really handy extension that allows you to store passwords for multiple sites. The advantage is that I have one single 20 character mixed password that I use to log into Lastpass and then using lastpass, I can generate passwords that are 50-100 characters and I don’t have to remember them. It provides the following benefits:",
      {
        "type": "list",
        "items": [
          "Extra security: I no longer have to use the same password for multiple sites so that I remember it.",
          "Autochanging password: One of the nice features is that lastpass reminds you to change password every set duration. This is useful for banking or applications that contain sensitive data",
          "Sharing passwords: I can share passwords with other users within my team without giving out my actual password and I can then change the password"
        ]
      },
  ...
  {
    "slug": "captain-america-civil-war-review",
    "title": "Captain America : Civil War Review",
    "date": "May 11, 2016",
    "category": "Movies",
    "tags": [
      "Movies"
    ],
    "excerpt": "**** Star movie! Captain America: Civil War could very well have been named Avengers as it includes one and all from the Marvel universe. We have Captain America, Iron Man, Ant Man,…",
    "body": [
      {
        "type": "heading",
        "text": "**** Star movie!"
  ...
  {
    "slug": "the-comcast-nightmare",
    "title": "The Comcast Nightmare",
    "date": "May 7, 2016",
    "category": "Uncategorized",
    "tags": [
      "Uncategorized"
    ],
    "excerpt": "After using streaming services like Netflix, hulu, etc. I found a deal with Comcast where they offered a nice TV and Internet bundle for around 50 bucks. I signed up for a deal after…",
    "body": [
  ...
  {
    "slug": "t-mobile-torture",
    "title": "T-Mobile Torture",
    ...
    "body": [
      ...
      "Once the documents were faxed, there was no way for me to know if they have been received by the frauds team as they are an offline team with no access to customer service reps. The person at the store mentioned it might well be 24 hours before service will be resumed. I went home tired and annoyed by the mess. The next day, I waited till late in the afternoon for my phone to ring but after more than 26 hours without connection, I called the 611 helpline again. I was told that the back of my ssn card is not clear and so they haven’t started the service!! There are two problems here",
      {
        "type": "list",
        "items": [
          "Why would T-mobile wait for me to call them instead of letting me know early in the day that I have to resend the documents?",
          "What in the name of God do you need the back of SSN card for? There is no information on the back except for some standard message common for all individuals."
        ]
      },
  ...
  {
    "slug": "north-yellowstone-winter-2015",
    "title": "North Yellowstone: Winter 2015",
    "date": "December 6, 2015",
    "category": "Travel and Food",
    "tags": [
      "Travel and Food"
    ],
    "excerpt": "My vacation in North Yellowstone during Thanksgiving 2015.",
    "body": [
      ...
      {
        "type": "heading",
        "text": "Tumbleweed bookstore and cafe"
      },
  ...
  {
    "slug": "prem-ratan-dhan-payo-maine-sardard-payo",
    "title": "Prem Ratan Dhan Payo : Maine Sardard payo",
  ...
  {
    "slug": "mongodb-3-0-authentication-issue",
    "title": "MongoDB 3.0 Authentication Issue",
    "date": "September 30, 2015",
    "category": "Technology",
    "tags": [
      "Technology"
    ],
    "excerpt": "We upgraded to MongoDB 3.0 version and that caused some of the tools that we used for visualization of Mongo data to stop working. We use Robomongo at my workplace and it started failing…",
    "body": [
      ...
      "There is a JIRA ticket that is open on the Mongo Issue list which can be found here. As mentioned in the issue, MONGODB_CR was an older authentication algorithm that was used prior to 3.x versions. This causes third party tools to stop working when we move to Mongo 3.x because they still try to authenticate using the older mechanism instead of using the newer SCRAM-SHA-1. I had to perform the following steps to fix the issue and it seems to have worked:",
      {
        "type": "list",
        "items": [
          "Start MongoDB in non authenticated mode. From the command line, it will be the command"
        ]
      },
      "mongod",
      "use admin",
  ...
  {
    "slug": "motorcycle-dl389-in-us",
    "title": "Motorcycle DL389 in US",
    "date": "September 20, 2015",
    "category": "Travel and Food",
    "tags": [
      "Travel and Food"
    ],
    "excerpt": "I’ve always loved riding a bike. In India, it provides the advantage of finding easy parking, faster maneuverability and it takes up less space in the garage. I owned a 100cc Splendor in…",
    "body": [
      ...
      "When I came to Texas for grad school, I noticed a large number of people driving on I-20 using cruiser bikes and I always felt that when I grow old, this is something I can see myself doing as well and don’t get my started on my love of sports bikes!! The zippy machines that zoom past you during the morning traffic on 101 do generate some envious glares from the car drivers. And then one of my friend ended up getting a bike in Texas and that meant I should at the very least get a head start in pursuing this dream to cruise around at old age. The first step is to get a driving license from DMV. Now, there are two ways to do this",
      {
        "type": "list",
        "items": [
          "Get a learning permit, drive a bike around for few months and finally give your driving test at DMV",
          "Join a Basic Rider Course, attend classroom sessions and at the end of the course, get the DL389 (waiver to give riding test)"
        ]
      },
      ...
      {
        "type": "heading",
        "text": "Bike Smart – Basic Rider Course"
      },
      "First off, please start looking for a class way in advance… these classes are always full and it was very difficult to get into one for me. I booked a class for September labor day weekend almost a month in advance. The classes are divided into classroom sessions and riding sessions. The class I took had following schedule: Classroom 6:30 PM to 10 PM on Thursday, Riding session 1:00 PM to 6 PM on Saturday followed by 6:30 pm to 10 PM classroom and finally one more riding session on Sunday from 1:00 to 6 PM. PLEASE BE ON TIME as they are not kidding about the timing policy and I actually had 2 people sent away just because they were a minute late.",
  ...
  {
    "slug": "the-spy-movie-review",
    "title": "The Spy: Movie Review",
    "date": "June 13, 2015",
    "category": "Movies",
    "tags": [
      "Movies"
